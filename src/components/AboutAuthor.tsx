  ...
  return (
    <section className="py-16 px-4 bg-gradient-section">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col author-layout items-center md:items-start">
          ...
          <div className="author-text">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
              <a href="https://scholar.google.com/citations?hl=en&user=ZP9xvMUAAAAJ" target="_blank" rel="noopener noreferrer" className="author-button">
                Research
              </a>
              <a href="https://www.linkedin.com/in/ibsmirnov/" target="_blank" rel="noopener noreferrer" className="author-button">
                LinkedIn
              </a>
            </div>
          </div>
